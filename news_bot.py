...
def process_with_ai(posts, history):
    ...
    ═══════════════════════════════════════════════════
    🥇 Топ: новые устройства, крупные анонсы, скандалы, прорывы, сделки
    🥈 Средние: обзоры, важные обновления
    ...
    📐 СТРУКТУРА:
    - Строка 1: спецсимвол + КОРОТКИЙ хук до 60 символов, <b>жирным</b>.
    - Пустая строка
    - Абзац 1: суть, 1-2 предложения.
    - Пустая строка
    - Абзац 2: детали, 2-3 предложения.
    - Пустая строка
    - Абзац 3 (опционально): вывод или ирония.
    ...
    - Спецсимволы в НАЧАЛЕ абзацев: → ✓ ▪ ▸ ● ◆ ⚡ 🔥 💡 ⚙️ 📱 💻 🚀 📊 🔔 ⏰ ⭐ 🎯 🧠 ⚠️ 🛠️ 📡
    - НЕ использовать: улыбочки 🙂😊😂, сердечки, мультяшные эмодзи, животных.
    - Максимум 2-3 спецсимвола на пост.

    ═══════════════════════════════════════════════════
    🔗 ССЫЛКИ — САМОЕ ГЛАВНОЕ ПРАВИЛО (прочитай ВНИМАТЕЛЬНО):
    ═══════════════════════════════════════════════════

    Ты ОБЯЗАН встроить ссылку на первоисточник ВНУТРЬ текста, на конкретном слове.

    ❌ КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО (так делать НЕЛЬЗЯ):
    - "Источник: https://..."
    - "Ссылка: https://..."
    - "Подробнее: <a href='...'>...</a>" в конце поста
    - "Читайте по ссылке: ..."
    - Отдельная строка со ссылкой в конце
    - Любая ссылка вне контекста текста

    ✅ ПРАВИЛЬНО (вот как надо):
    Ссылка встроена ВНУТРЬ предложения, на осмысленном слове.
    
    ПРИМЕР 1:
    "⚡ <b>Apple показала новый чип M5</b>\\n\\nНовый процессор в <a href='https://apple.com/newsroom'>официальном анонсе</a> Apple обещает 40% прирост производительности.\\n\\nПервые тесты показывают, что чип обходит конкурентов от Qualcomm."

    ПРИМЕР 2:
    "🚀 <b>Samsung анонсировала Galaxy S26</b>\\n\\nКомпания <a href='https://samsung.com/news'>подтвердила</a> дату презентации — 15 февраля.\\n\\nГлавные изменения коснутся камеры и нового чипа Exynos."

    ПРИМЕР 3 (когда ссылки на первоисточник нет в исходном посте):
    "💡 <b>Новая функция в Telegram</b>\\n\\nМессенджер добавил возможность редактировать сообщения в течение 48 часов.\\n\\nФункция уже доступна всем пользователям."

    📌 КОГДА ВСТАВЛЯТЬ ССЫЛКУ:
    - Если в исходном посте есть внешняя ссылка (из блока "Внешние ссылки в посте") — ОБЯЗАТЕЛЬНО вставь её ВНУТРЬ текста.
    - Вставь ссылку на слове, которое логично с ней связано (название компании, источник новости, ключевое слово).
    - Если внешних ссылок нет — НЕ вставляй ссылку вообще. Не выдумывай URL!

    📌 КАК ВСТАВЛЯТЬ:
    - Формат HTML: <a href="URL">осмысленный текст</a>
    - Текст ссылки — 1-4 слова, осмысленные в контексте.
    - Ссылка должна выглядеть как обычное слово в тексте. Читатель не должен понимать, что это ссылка, пока не наведёт курсор.

    ═══════════════════════════════════════════════════
    ❌ ЗАПРЕЩЕНО:
    - Хештеги
    - "Подробнее на канале X", "читайте на сайте Y", "источник: Z"
    - Markdown. Только HTML.
    - Слипшийся текст без абзацев
    - Ссылка в конце поста отдельной строкой
    - Улыбочки и мультяшные эмодзи
    ...
    ═══════════════════════════════════════════════════
    {{
      "post_text": "⚡ <b>Заголовок</b>\\n\\nПервый абзац с <a href='URL'>ссылкой внутри</a> на нужном слове.\\n\\nВторой абзац с деталями.\\n\\n→ Третий абзац с выводом.",
